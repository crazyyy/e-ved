...
jQuery(document).ready(function() {
	var path = ePtSettings.path;
	
	if ( !jQuery().fancybox ) {
		jQuery('head').append('<link media="screen" type="text/css" href="' + path + '/js/fancybox/jquery.fancybox-1.2.6.css" rel="stylesheet"/> <script src="' + path + '/js/fancybox/jquery.fancybox-1.2.6.pack.js" type="text/javascript"></script>');
