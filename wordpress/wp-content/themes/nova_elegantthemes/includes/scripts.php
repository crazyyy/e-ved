<?php global $shortname; ?>
	...
	<script src="<?php bloginfo('template_directory'); ?>/js/Thin_400.font.js" type="text/javascript"></script>
    <script src="<?php bloginfo('template_directory'); ?>/js/Medium_400.font.js" type="text/javascript"></script>
	<script type="text/javascript">
		<?php 
			if ( get_option($shortname.'_color_scheme') =='Grey' ) $shadow = 'fff';
			else $shadow = '000';
		?>
		Cufon.set('fontFamily', 'Thin');
		Cufon.replace('h1.title')('h3.widgettitle')('h3#comments')('div.entry.clearfix h2.title')('div.description h2.title a, div.description p')('#entries-area h6',{textShadow:'1px 1px 1px #<?php echo $shadow; ?>'})('ul#main-tabs li a span', {textShadow:'1px 1px 1px #fff'})('span.fn')('.tab-slide h3.title');
		
		Cufon.set('fontFamily', 'Medium');
		Cufon.replace('div.description h2.title a span')('div.description p span',{textShadow:'1px 1px 1px #<?php echo $shadow; ?>'})('.tab-slide h3.title span',{textShadow:'1px 1px 1px #fff'});
	</script>
