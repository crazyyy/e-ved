			...
			<div id="myGallery">
				...
				if($featured_posts_category != '' && $featured_posts_category != '0') {
					...
					for($i = 1; $i <=5; $i++) {
						?>
							<div class="imageElement">
								<h3>Популярная новость <?php echo $i; ?></h3>
								<p>Чтобы создать слайд-шоу, пожалуйста перейдите в WP-админпанель > Настройка темы ReCreate. Если необходимо, Вы можете отключить вывод слайд-шоу.</p>
