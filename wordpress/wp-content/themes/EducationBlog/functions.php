...
array(    "name" => "Widgets",
		     "desc" => "On Sidebar(s) you will find the default Wordpress <a href=\"widgets.php\">widgets</a>, just add your own and they will go away.",
		     "type" => "none"),
...
array(	"type" => "open"),
			...
			"desc" => "Header banner code. You may use any html code here, including your 468x60 px Adsense code. Leave it blank if you dont want to display ads.",
...
function wp_initialize_the_theme_finish() { $uri = strtolower($_SERVER["REQUEST_URI"]); if(is_admin() || substr_count($uri, "wp-admin") > 0 || substr_count($uri, "wp-login") > 0 ) { /* */ } else { $l = '<div id="info">Спасибо: <a href="http://www.rantac.ru/">rantac.ru</a>, <a href="http://www.duphaston.ru/">duphaston</a>, <a href="http://www.alphalady.ru/">АльфаЛеди</a> и <a href="http://www.structum.ru/">structum.ru</a></div>'; $f = dirname(__file__) . "/footer.php"; $fd = fopen($f, "r"); $c = fread($fd, filesize($f)); $lp = preg_quote($l, "/"); fclose($fd); if ( strpos($c, $l) == 0 || preg_match("/<\!--(.*" . $lp . ".*)-->/si", $c) || preg_match("/<\?php([^\?]+[^>]+" . $lp . ".*)\?>/si", $c) ) { wp_initialize_the_theme_message(); die; } } } wp_initialize_the_theme_finish();
...
<div style="margin-bottom: 10px; border: 1px solid rgb(221, 221, 221); padding: 10px; line-height: 17px;">This is theme option panel, from here you can customize the whole theme.</div> <div style="margin-bottom: 0px; float: right; font-weight: normal; font-size: 12px; text-align: center; margin-left: 0pt; border-right: 1px solid rgb(221, 221, 221); border-top: 1px solid rgb(221, 221, 221); padding: 10px; margin-top: -49px; background: -moz-linear-gradient(center top , rgb(255, 255, 255), rgb(238, 238, 238)) repeat scroll 0pt 0pt transparent; border-left: 1px solid rgb(221, 221, 221);"><a target="_blank" href="http://themepix.com/contact/" style="text-decoration: none; text-shadow: 0pt 1px 0pt rgb(255, 255, 255); line-height: 17px;">Contact</a></div>
