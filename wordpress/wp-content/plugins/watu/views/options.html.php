<div class="wrap">
	...
	<div class="postbox">
		...
		<div class="inside" style="padding:8px">
			<label>&nbsp;<input type='checkbox' value="1" name='use_the_content' <?php if(get_option('watu_use_the_content') == '1') echo 'checked'?>  />&nbsp;<?php _e('Use "the_content" instead of our custom content filter (do not select this unless adviced so)', 'watu')?> </label>
		</div>
	</div>
