...
class SGAntiVirus {
	...
	public static function page_PreScan($params)
	{
		...
		if (intval($params['scans']) == 30 || intval($params['scans']) == 15)
		{
...
You have: 
<?php
if ($params['membership'] == 'pro' || $params['membership'] == 'trial') $tmp_label_class = 'label_green';
else $tmp_label_class = 'label_red';
?>
<span class="<?php echo $tmp_label_class; ?>"><?php echo ucwords($params['membership']); ?> version</span> (ver. <?php echo SGAntiVirus_module::$antivirus_version; ?>)<br />
...
{/*
    ?>
    Total installed plugins: <?php echo $stats['total_plugin']; ?> (Disabled: <?php echo $stats['total_disabled_plugins']; ?>) <span class="label_red">Review is required</span> [<a href="https://www.siteguarding.com/en/services/malware-removal-service" target="_blank">Review My Website</a>]';
    <?php */
}
...
<div style="width:45%; float:left;">
    <div class="ui list">
<div class="mod-box"><div>	
<h3 class="apv_header">Website Status</h3>		
<p>
<?php
...
?>
<br />
Google Blacklist Status: <?php if ($params['blacklist']['google'] != 'ok') echo '<span class="label_red">Blacklisted ['.$params['blacklist']['google'].']</span> [<a href="https://www.siteguarding.com/en/services/malware-removal-service" target="_blank">Remove From Blacklist</a>]'; else echo '<span class="label_green">Not blacklisted</span>'; ?>
<br />
Bruteforce Protection: <?php if (intval($avp_params['protect_login_page']) == 0) echo '<span class="label_red">Disabled</span> [<a href="admin.php?page=plgavp_Antivirus_settings_page">Enable</a>]'; else echo '<span class="label_green">Enabled</span>'; ?>
&nbsp;[<a href="https://www.siteguarding.com/en/bruteforce-attack" target="_blank">Info</a>]
...
<div class="clear"></div>
    ...
    ?>
        <div class="important_notes_box">
        <h4 class="msg_alert" style="margin:0 0 7px 0">Important notes</h4>
        <ul>
        <?php
        if ($stats['total_admin_users'] > 2) {
        ?>
            <li>We have detected <span class="msg_alert"><b><?php echo $stats['total_admin_users']; ?> accounts with administrator level</b></span> (<a href="users.php?role=administrator" target="_blank">View site admins</a>). If you see any fake accounts or old accounts (freelancers, developers, etc) remove them or change the password. It's the most simple and common way to hack your website. <a href="https://www.siteguarding.com/en/old-or-fake-administrator-accounts" target="_blank">Learn more</a></li>
        <?php
        }
        if ($stats['total_disabled_plugins'] > 2) {
        ?>
            <li>We have detected <?php echo $stats['total_plugins']; ?> installed plugins and <span class="msg_alert"><b><?php echo $stats['total_disabled_plugins']; ?> plugins are disabled</b></span> (<a href="plugins.php?plugin_status=inactive" target="_blank">View plugins</a>). The files of not active plugins still on the server and hackers can use the files or bugs of these plugins. <a href="https://www.siteguarding.com/en/disabled-plugins-and-extensions" target="_blank">Learn more</a></li>
        <?php
        }
        ?>
        </ul>
...
?>
	...
	public static function PatchWPLogin_file($action = true)   // true - insert, false - remove
	{
        ...
        $filename = $scan_path.DIRSEP.'wp-login.php';
        $handle = fopen($filename, "r");
