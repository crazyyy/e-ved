      ...
      <div class="post">
        ...
        <div class="box">
          <div class="postimgbox">
            ...
            <?php inkthemes_get_thumbnail(200, 144); ?>
            <?php } else { ?>
            <?php inkthemes_get_image(200, 144); ?>
            <?php
                    }
                    ?>
          </div>
		...
		<h1 class="post_title"><a href="<?php the_permalink() ?>" rel="bookmark" title="Permanent Link to <?php the_title_attribute(); ?>">
          ...
          <?php the_excerpt(); ?>
          <a class="read_more" href="<?php the_permalink() ?>"><?php echo TAKE_A_TOUR; ?><span class="button-tip"></span></a> </div>
      </div>
      <!--End Post-->
      <?php endwhile;
else: ?>
