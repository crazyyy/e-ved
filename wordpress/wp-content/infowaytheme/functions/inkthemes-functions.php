...
function inkthemes_register_custom_menu() {
    register_nav_menu('custom_menu', MAIL_MENU);
}
...
function inkthemes_breadcrumbs() {
    ...
    if (get_query_var('paged')) {
        if (is_category() || is_day() || is_month() || is_year() || is_search() || is_tag() || is_author())
            echo ' (';
        echo PAGE_TEXT . ' ' . get_query_var('paged');
        if (is_category() || is_day() || is_month() || is_year() || is_search() || is_tag() || is_author())
            echo ')';
    }
    echo '</div>';
...
// Retrieves tag list of current post, separated by commas.
    ...
    if ($tag_list) {
        $posted_in = THIS_ENTRY_WAS_POSTED_IN .' '.AND_TAGGED .''.BOOKMARK_THE.'<a href="%3$s" title="Permalink to %4$s" rel="bookmark">permalink</a>.';
    } elseif (is_object_in_taxonomy(get_post_type(), 'category')) {
        $posted_in = THIS_ENTRY_WAS_POSTED_IN.' '. ' '.BOOKMARK_THE.'<a href="%3$s" title="Permalink to %4$s" rel="bookmark">permalink</a>.';
    } else {
...
// Area 1, located at the top of the sidebar.
    register_sidebar(array(
        ...
        'description' => THE_PRIMARY_WIDGET_AREA,
        'before_widget' => '',
        'after_widget' => '',
...
// Area 2, located below the Primary Widget Area in the sidebar. Empty by default.
    register_sidebar(array(
        ...
        'description' => THE_SECONDARY_WIDGET_AREA,
        'before_widget' => '',
        'after_widget' => '',
        'before_title' => '<h3><a href="#">',
        'after_title' => '</a></h3>',
    ...
    register_sidebar(array(
        'name' => HOME_PAGE_RIGHT_FEATURE_WIDGET_AREA,
        'id' => 'home-page-right-feature-widget-area',
        'description' => THE_HOME_PAGE_RIGHT_FEATURE_WIDGET_AREA,
        'before_widget' => '',
        'after_widget' => '',
        'before_title' => '<h4>',
        'after_title' => '</h4>',
    ...
    register_sidebar(array(
        'name' => FIRST_FOOTER_WIDGET_AREA,
        'id' => 'first-footer-widget-area',
        'description' => THE_FIRST_FOOTER_WIDGET_AREA,
        'before_widget' => '',
        'after_widget' => '',
        'before_title' => '<h4>',
        'after_title' => '</h4>',
    ...
    register_sidebar(array(
        'name' => SECOND_FOOTER_WIDGET_AREA,
        'id' => 'second-footer-widget-area',
        'description' => THE_SECOND_FOOTER_WIDGET_AREA,
        'before_widget' => '',
        'after_widget' => '',
        'before_title' => '<h4>',
        'after_title' => '</h4>',
    ...
    register_sidebar(array(
        'name' => THIRD_FOOTER_WIDGET_AREA,
        'id' => 'third-footer-widget-area',
        'description' => THE_THIRD_FOOTER_WIDGET_AREA,
        'before_widget' => '',
        'after_widget' => '',
        'before_title' => '<h4>',
        'after_title' => '</h4>',
    ...
    register_sidebar(array(
        'name' => FOURTH_FOOTER_WIDGET_AREA,
        'id' => 'fourth-footer-widget-area',
        'description' => THE_FOURTH_FOOTER_WIDGET_AREA,
        'before_widget' => '',
        'after_widget' => '',
        'before_title' => '<h4>',
        'after_title' => '</h4>',
